...
DRILLS.push({
  ...
  items: [
    { q: '… <b>langas</b> <i>(окно)</i> — <i>naujas (новый)</i>', hint: 'Langas (окно) — jis.', ans: ['naujas'],
    ...
    { q: '… <b>gėlė</b> <i>(цветок)</i> — <i>gražus (красивый)</i>', hint: 'Gėlė — ji.', ans: ['graži'],
    ...
    { q: '… <b>durys</b> <i>(дверь)</i> — <i>medinis (деревянный)</i>', hint: 'Durys (дверь) — jos.', ans: ['medinės'],
    ...
    { q: '… <b>sūnūs</b> <i>(сыновья)</i> — <i>geras (хороший)</i>', hint: 'Sūnūs (сыновья) — jie.', ans: ['geri'],
    ...
    { q: '… <b>moterys</b> <i>(женщины)</i> — <i>linksmas (весёлый)</i>', hint: 'Moterys (женщины) — jos.', ans: ['linksmos'],
    ...
    { q: '… <b>akiniai</b> <i>(очки)</i> — <i>naujas (новый)</i>', hint: 'Akiniai (очки) — jie.', ans: ['nauji'],
...
DRILLS.push({
  ...
  items: [
    { q: 'Matau … <i>(naujas langas — новое окно)</i>', hint: 'Действие matau требует ką?', ans: ['naują langą'],
    ...
    { q: 'Matau … <i>(graži mergaitė — красивая девочка)</i>', hint: 'У graži внутри спрятана -ia-.', ans: ['gražią mergaitę'],
    ...
    { q: 'Valau … <i>(švarus stalas — чистый стол)</i>', hint: 'Прилагательное на -us.', ans: ['švarų stalą'],
      rule: 'u → ų, a → ą', opts: [
    ...
    { q: 'Perku … <i>(medinė kėdė — деревянный стул)</i>', hint: 'Оба слова на -ė.', ans: ['medinę kėdę'],
      rule: 'ė → ę', opts: [
    ...
    { q: 'Matau … <i>(didelis brolis — большой брат)</i>', hint: 'Оба слова на -is.', ans: ['didelį brolį'],
      rule: 'i → į', opts: [
    ...
    { q: 'Geriu … <i>(saldi arbata — сладкий чай)</i>', hint: 'У saldi та же скрытая -ia-, что и у graži.', ans: ['saldžią arbatą'],
    ...
    { q: 'Turiu … <i>(geras sūnus — хороший сын)</i>', hint: 'Прилагательное на -as, предмет на -us.', ans: ['gerą sūnų'],
    ...
    { q: 'Matau … <i>(linksma moteris — весёлая женщина)</i>', hint: 'Moteris — женское на -is.', ans: ['linksmą moterį'],
      rule: 'a → ą, i → į', opts: [
    ...
    { q: 'Geriu … <i>(šaltas vanduo — холодная вода)</i>', hint: 'У vanduo меняется вся основа.', ans: ['šaltą vandenį'],
    ...
    { q: 'Skaitau … <i>(įdomi knyga — интересная книга)</i>', hint: 'Прилагательное группы -us в женской форме.', ans: ['įdomią knygą'],
...
DRILLS.push({
  ...
  items: [
    { q: 'Matau … <i>(nauji langai — новые окна)</i>', hint: 'Мужское множественное.', ans: ['naujus langus'],
    ...
    { q: 'Perku … <i>(gražios gėlės — красивые цветы)</i>', hint: 'Женское на -ės.', ans: ['gražias gėles'],
    ...
    { q: 'Statau … <i>(medinės kėdės — деревянные стулья)</i>', hint: 'Оба слова женские на -ės.', ans: ['medines kėdes'],
      rule: '-ės → -es', opts: [
    ...
    { q: 'Matau … <i>(dideli broliai — большие братья)</i>', hint: 'Мужское множественное.', ans: ['didelius brolius'],
    ...
    { q: 'Turiu … <i>(gražūs sūnūs — красивые сыновья)</i>', hint: 'Здесь прилагательное и предмет расходятся.', ans: ['gražius sūnus'],
    ...
    { q: 'Kviečiu … <i>(linksmos moterys — весёлые женщины)</i>', hint: 'Женское на -is.', ans: ['linksmas moteris'],
    ...
    { q: 'Atidarau … <i>(medinės durys — деревянная дверь)</i>', hint: 'Только множественное, женское.', ans: ['medines duris'],
    ...
    { q: 'Valgau … <i>(saldūs obuoliai — сладкие яблоки)</i>', hint: 'Прилагательное на -us + мягкая основа.', ans: ['saldžius obuolius'],
    ...
    { q: 'Nešioju … <i>(nauji akiniai — новые очки)</i>', hint: 'Только множественное, мужское.', ans: ['naujus akinius'],
    ...
    { q: 'Matau … <i>(juodos katės — чёрные кошки)</i>', hint: 'Оба слова женские.', ans: ['juodas kates'],
...
DRILLS.push({
  ...
  items: [
    { q: '<b>graži mergaitė</b> <i>(красивая девочка)</i> → ką? …', hint: 'graži (красивая) = gražia', ans: ['gražią mergaitę'],
    ...
    { q: '<b>saldi arbata</b> <i>(сладкий чай)</i> → ką? …', hint: 'saldi (сладкая) = saldia, d → dž', ans: ['saldžią arbatą'],
    ...
    { q: '<b>karti kava</b> <i>(горький кофе)</i> → ką? …', hint: 'karti (горькая) = kartia, t → č', ans: ['karčią kavą'],
    ...
    { q: '<b>plati gatvė</b> <i>(широкая улица)</i> → ką? …', hint: 'plati (широкая) = platia, t → č', ans: ['plačią gatvę'],
    ...
    { q: '<b>rami naktis</b> <i>(спокойная ночь)</i> → ką? …', hint: 'rami (спокойная) = ramia; naktis (ночь) — женское на -is', ans: ['ramią naktį'],
...
DRILLS.push({
  ...
  items: [
    { q: 'Noriu … <i>(kava — кофе)</i>', hint: 'Norėti зовёт не galininkas.', ans: ['kavos'],
    ...
    { q: 'Matau … <i>(kava — кофе)</i>', hint: 'А вот matyti зовёт galininkas.', ans: ['kavą'],
    ...
    { q: 'Laukiu … <i>(draugas — друг)</i>', hint: 'Laukti зовёт kilmininkas.', ans: ['draugo'],
    ...
    { q: 'Padedu … <i>(mama — мама)</i>', hint: 'Padėti зовёт naudininkas.', ans: ['mamai'],
    ...
    { q: 'Klausausi … <i>(daina — песня)</i>', hint: 'Klausytis зовёт kilmininkas.', ans: ['dainos'],
    ...
    { q: 'Nematau … <i>(naujas langas — новое окно)</i>', hint: 'Отрицание меняет падеж.', ans: ['naujo lango'],
...
DRILLS.push({
  ...
  items: [
    { q: 'Я вижу новое окно.', ans: ['Matau naują langą', 'Aš matau naują langą'],
      hint: 'matyti (видеть) → matau · langas (окно) — jis',
    ...
    { q: 'Мама покупает красивые цветы.', ans: ['Mama perka gražias gėles'],
      hint: 'pirkti (покупать) → perka · gėlės (цветы) — jos',
    ...
    { q: 'Он пьёт горячий чай.', ans: ['Jis geria karštą arbatą'],
      hint: 'gerti (пить) → geria · arbata (чай) — ji',
    ...
    { q: 'Дети едят сладкие яблоки.', ans: ['Vaikai valgo saldžius obuolius'],
      hint: 'valgyti (есть) → valgo · obuoliai (яблоки) — jie',
    ...
    { q: 'Она читает интересную книгу.', ans: ['Ji skaito įdomią knygą'],
      hint: 'skaityti (читать) → skaito · knyga (книга) — ji',
    ...
    { q: 'Мы открываем деревянные двери.', ans: ['Atidarome medines duris', 'Mes atidarome medines duris'],
      hint: 'atidaryti (открывать) → atidarome · durys (дверь) — jos, только множественное',
    ...
    { q: 'Учитель приглашает весёлых гостей.', ans: ['Mokytojas kviečia linksmus svečius'],
      hint: 'kviesti (приглашать) → kviečia · svečiai (гости) — jie',
    ...
    { q: 'Я держу маленькую кошку.', ans: ['Laikau mažą katę', 'Aš laikau mažą katę'],
      hint: 'laikyti (держать) → laikau · katė (кошка) — ji',
    ...
    { q: 'Мама греет тёплое молоко.', ans: ['Mama šildo šiltą pieną'],
      hint: 'šildyti (греть) → šildo · pienas (молоко) — jis',
