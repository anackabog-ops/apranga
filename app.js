...
/* ---- переключатель светлой и тёмной темы (собственный, ключ dd-theme) ---- */
(function () {
  var root = document.documentElement, b = document.getElementById('dd-theme');
  if (!b) return;
  b.addEventListener('click', function () {
    ...
    try { localStorage.setItem('dd-theme', next); } catch (e) { /* хранилище недоступно */ }
  });
})();
